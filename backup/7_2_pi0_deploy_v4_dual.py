...
# Arm 模型配置 (V4.1)
ARM_CONFIG = {
    'model_path': './ckpt/pi0_arm/pretrained_model_arm_v5_2',
    'dataset_repo_id': 'omy_arm_data_v5_2',
...
def main():
    ...
    if arm_policy is not None:
        # V4 arm 模式与 V2 一致：只使用同步推理
        print("🔄 [ARM] Using SYNC inference mode (same as V2)")
