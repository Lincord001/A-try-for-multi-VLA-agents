...
def _build_offset_xml_bundle(base_scene_xml_path, z_offset):
    ...
    table_src = os.path.join(repo_root, "asset", "tabletop_v6", "object", "object_table_v6.xml")
    ...
    table_dst = os.path.join(
        repo_root, "asset", "tabletop_v6", "object", "object_table_v6_offset_generated.xml"
    )
    ...
    scene_dst = os.path.join(asset_root, "example_scene_y6_offset_generated.xml")
    ...
    for include in scene_root.findall(".//include"):
        ...
        if "tabletop_v6/object/object_table_v6.xml" in inc:
            include.set("file", "./tabletop_v6/object/object_table_v6_offset_generated.xml")
    ...
    print(
        f"[V6_Z_OFFSET] Using runtime XML bundle with z_offset={z_offset:+.3f} at: {scene_dst}"
    )
    return scene_dst
