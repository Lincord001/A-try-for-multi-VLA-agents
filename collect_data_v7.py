...
BASE_DATASET_NAME = 'omy_base_data_v7_6'     # Base 模式数据集名称  
BASE_DATASET_ROOT = './demo_data_base_v7_6'  # Base 模式数据集保存路径
...
def main():
    ...
    _apply_instruction_from_group(
        PnPEnv, current_mode, instruction_group_indices, last_instruction_by_mode, log_prefix="[INIT]"
    )
