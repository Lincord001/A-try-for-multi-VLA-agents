...
#   - tb3_x_gaussian_enabled: 是否启用 TB3 X 高斯扰动 (可选，默认全局 TB3_X_GAUSSIAN_ENABLED)
#   - tb3_x_center/tb3_x_offset_std/tb3_x_offset_min/tb3_x_offset_max: TB3 X 随机化参数（可选，默认全局）
# 
MULTI_CONFIG_RECORDING = [
    {
        ...
        'tb3_x_gaussian_enabled': True,  # 可选，不设置则使用全局默认值
    },
    {
        'name': 'stage_2',
        'target_episodes': 200,
...
def main():
    ...
    print(
        f"🚗 TB3 X Randomization: {'Gaussian' if TB3_X_GAUSSIAN_ENABLED else 'Fixed'} "
                ...
                if auto_state != AUTO_STATE_IDLE and current_mode == 'arm':
                    ...
                    if auto_state == AUTO_STATE_RESETTING:
                        ...
                        if auto_use_multi_config and auto_current_config is not None:
                            ...
                            config_tb3_x_gaussian_enabled = auto_current_config.get('tb3_x_gaussian_enabled', TB3_X_GAUSSIAN_ENABLED)
                            config_tb3_x_center = auto_current_config.get('tb3_x_center', TB3_X_CENTER)
                            config_tb3_x_offset_std = auto_current_config.get('tb3_x_offset_std', TB3_X_OFFSET_STD)
                            config_tb3_x_offset_min = auto_current_config.get('tb3_x_offset_min', TB3_X_OFFSET_MIN)
                            config_tb3_x_offset_max = auto_current_config.get('tb3_x_offset_max', TB3_X_OFFSET_MAX)
                            # 更新环境的随机初始化参数
                            ...
                            # 🔥 更新环境的 TB3 X 随机化参数
                            PnPEnv.tb3_x_gaussian_enabled = config_tb3_x_gaussian_enabled
                            PnPEnv.tb3_x_center = config_tb3_x_center
                            PnPEnv.tb3_x_offset_std = config_tb3_x_offset_std
                            PnPEnv.tb3_x_offset_min = config_tb3_x_offset_min
                            PnPEnv.tb3_x_offset_max = config_tb3_x_offset_max
                        else:
                            # 单配置模式：使用全局默认参数
                            ...
                            config_tb3_x_gaussian_enabled = TB3_X_GAUSSIAN_ENABLED
                            config_tb3_x_center = TB3_X_CENTER
                            config_tb3_x_offset_std = TB3_X_OFFSET_STD
                            config_tb3_x_offset_min = TB3_X_OFFSET_MIN
                            config_tb3_x_offset_max = TB3_X_OFFSET_MAX
                            PnPEnv.tb3_x_gaussian_enabled = config_tb3_x_gaussian_enabled
                            PnPEnv.tb3_x_center = config_tb3_x_center
                            PnPEnv.tb3_x_offset_std = config_tb3_x_offset_std
                            PnPEnv.tb3_x_offset_min = config_tb3_x_offset_min
