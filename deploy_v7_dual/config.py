...
BASE_POST_STOP_NUDGE_ENABLED = True
BASE_POST_STOP_NUDGE_WHEEL_SPEED = 2.0
BASE_POST_STOP_NUDGE_MAX_SECONDS = 1.5
BASE_POST_STOP_NUDGE_MAX_DISTANCE = 0.05
BASE_POST_STOP_NUDGE_STALL_SECONDS = 0.25
BASE_POST_STOP_NUDGE_STALL_PROGRESS = 0.002
BASE_POST_STOP_NUDGE_YAW_TOL = np.deg2rad(5.0)
...
RAG_MAX_WHEEL_SPEED = 18.0
RAG_MIN_FWD_SPEED = 4.0          # 提高巡航下限，减少低速爬行
RAG_MAX_FWD_SPEED = 6.0          # 直行巡航速度收回到 6 附近，给 VLM 检索留时间
RAG_TURN_GAIN = 2.5
RAG_MAX_TURN_SPEED = 4.2
...
TASK_REPLANNER_ENABLED = False
TASK_REPLANNER_AUTO_APPLY = False
TASK_REPLANNER_MODEL = "qwen-vl-max-latest"
TASK_REPLANNER_MAX_NEW_TASKS = 5
